export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    packageScopeHintCodex: '当前余额线路：Codex，仅可绑定 Codex 分组。',
    packageScopeHintGeneral: '当前余额线路：General，仅可绑定 General 分组。',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
  ...
  admin: {
    ...
    groups: {
      ...
      packageScope: '线路类型',
      packageScopeHint: '标准余额分组需要绑定到某一条余额线路，用户购买对应线路后才能看到并使用该分组。',
      exclusiveObj: {
        yes: '是',
        no: '否'
      },
  ...
  payment: {
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      PACKAGE_SCOPE_NOT_ALLOWED: '当前余额线路不支持此分组或支付对象。',
      PACKAGE_SCOPE_CONFLICT: '当前仍有其它线路余额，无法购买新的余额包线路。',
