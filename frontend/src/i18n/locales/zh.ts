export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    packageScopeHintCodex: '当前余额模式：Codex，仅可绑定 Codex 分组。',
    packageScopeHintGeneral: '当前余额模式：General，可用于 Claude 和 Codex 使用场景。',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
  ...
  monitorCommon: {
    ...
    history60pts: '近 30 分钟 · {n} 个时间段',
    realtimeWindow30m: '近 30 分钟',
  ...
  admin: {
    ...
    users: {
      ...
      withdrawAll: '全部',
      packageScope: '余额包模式',
      packageScopeHint: '选择本次充值后的余额归属模式。',
      packageScopeSwitchWarning: '选择的模式与当前余额模式不同，确认后会清零旧模式余额，并只保留本次充值金额。',
    ...
    groups: {
      ...
      packageScope: '余额模式',
      packageScopeHint: '标准余额分组需要绑定到某一种余额模式，用户购买对应模式后才能看到并使用该分组。',
      exclusiveObj: {
        yes: '是',
        no: '否'
      },
    ...
    providerStatus: {
      title: '供应商账号状态',
      description: '基于真实使用记录查看各供应商账号可用率、错误和延迟表现，不主动探测上游。',
      refresh: '刷新',
      loadError: '加载供应商账号状态失败',
      empty: '该时间窗口内暂无请求',
      totalRequests: '总请求',
    ...
    clientFailures: {
      title: '客户端失败统计',
      description: '查看请求进入系统后、分配上游账号前失败的情况。页面只按用户聚合，不展示上游账号。',
      refresh: '刷新',
      loadError: '加载客户端失败统计失败',
      empty: '该时间窗口内暂无客户端失败',
      emptyHint: '说明当前没有明显的请求体读取、解析或入站校验失败。',
      tableTitle: '按用户聚合',
      tableHint: '统计来自已有使用记录和错误记录，不主动探测上游。',
      clickHint: '点击用户查看最近失败明细',
      totalFailures: '失败总数',
      affectedUsers: '影响用户',
      affectedKeys: '影响 Key',
      user: '用户',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '开启用户端邀请返利入口，并配置全局返利比例、冻结期和专属用户规则。默认关闭。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户端侧边栏入口隐藏，注册返利码和返利展示不可用。',
          rebateRate: '全局返利比例',
          rebateRateHint: '普通邀请关系使用的默认返利比例，专属用户可单独覆盖。',
          freezeHours: '返利冻结时间（小时）',
          freezeHoursDesc: '返利生成后先进入待解冻状态，到期后才可提现。',
          durationDays: '返利有效周期（天）',
          durationDaysDesc: '限制被邀请用户在注册后多少天内产生返利；填 0 表示不限制周期。',
          perInviteeCap: '单个被邀请人返利上限',
          perInviteeCapDesc: '同一个被邀请人累计产生的返利上限；填 0 表示不限制。',
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户配置专属邀请码和专属返利比例。',
            addButton: '添加用户',
            searchPlaceholder: '搜索邮箱或用户名',
            batchButton: '批量设置（{count}）',
            col: {
              email: '邮箱',
              username: '用户名',
              code: '邀请码',
            ...
            customBadge: '专属',
            useGlobal: '使用全局比例',
            totalLabel: '共 {total} 个用户',
            resetTitle: '清除专属配置',
            resetMessage: '确定要清除 {email} 的专属邀请码和返利比例吗？系统会重新生成普通邀请码。',
          },
          modal: {
            addTitle: '添加专属用户',
            editTitle: '编辑专属用户',
            ...
            codeLabel: '专属邀请码',
            codePlaceholder: '留空则使用系统生成的邀请码',
            codeHint: '可设置易记的邀请码；留空则不修改。',
            rateLabel: '专属返利比例',
            ratePlaceholder: '留空使用全局比例',
            rateHint: '填写 0-100 之间的百分比；留空表示使用全局比例。',
            errorEmpty: '请选择用户或填写有效配置后再保存。',
            errorBadRate: '返利比例必须在 0 到 100 之间。',
          },
          batchModal: {
            title: '批量设置返利比例（{count} 个用户）',
            hint: '为选中的专属用户统一设置返利比例。',
            placeholder: '例如 10',
            clearHint: '留空提交将清除这些用户的专属返利比例，改用全局比例。',
          },
        },
      },
  ...
  purchase: {
    title: '充值订阅',
    description: '购买余额包或订阅套餐，完成充值、续费和余额模式管理',
    openInNewTab: '新窗口打开',
  ...
  payment: {
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      PACKAGE_SCOPE_NOT_ALLOWED: '当前余额模式不支持此分组或支付对象。',
      PACKAGE_SCOPE_CONFLICT: '当前仍有其它余额模式的余额，无法直接购买新的余额包。',
      REFUND_UNSUPPORTED: '余额包订单暂不支持自动退款，请联系管理员处理。',
      BALANCE_PACKAGE_REFERENCED: '该余额包已被历史订单引用，无法删除，请先下架。',
    },
    ...
    admin: {
      ...
      planName: '套餐名称',
      balancePackageName: '余额包名称',
      planDescription: '套餐描述',
      createPlan: '创建套餐',
      editPlan: '编辑套餐',
      deletePlan: '删除套餐',
      deletePlanConfirm: '确定要删除此套餐吗？',
      createBalancePackage: '创建余额包',
      editBalancePackage: '编辑余额包',
      deleteBalancePackage: '删除余额包',
      deleteBalancePackageConfirm: '确定要删除此余额包吗？',
      originalPrice: '原价',
      price: '价格',
      balancePackageCreditAmount: '到账余额',
      balancePackageProductName: '支付商品名',
      balancePackageDisplayTags: '展示标签',
      balancePackageDisplayTagsPlaceholder: '输入标签后回车或点击添加',
      balancePackageDisplayTagsHint: '最多添加 3 个展示标签，每个标签建议不超过 10 个字。',
      validityDays: '有效期（天）',
      validityUnit: '有效期单位',
      sortOrder: '排序',
      forSale: '上架状态',
