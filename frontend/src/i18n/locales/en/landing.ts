export default {
  ...
  home: {
    ...
    landing: {
      ...
      primaryCta: 'Ask in QQ group',
      successCta: 'QQ group number copied',
      createAccountCta: 'Create account',
      ctaHint: 'New users can create an account first. For questions, support, or after-sales help, click “Ask in QQ group” to copy the group number.',
