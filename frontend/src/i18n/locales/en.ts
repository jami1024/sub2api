export default {
  ...
  keys: {
    ...
    packageScopeHintCodex: 'Current balance mode: Codex. You can only bind Codex groups.',
    packageScopeHintGeneral: 'Current balance mode: General. It applies to Claude and Codex usage scenarios.',
    statusLabel: 'Status',
  ...
  monitorCommon: {
    ...
    history60pts: 'Last 30 min · {n} buckets',
    realtimeWindow30m: 'Last 30 min',
  ...
  profile: {
    ...
    balanceModeCodex: 'Codex',
    balanceModeGeneral: 'General',
  ...
  admin: {
    ...
    groups: {
      ...
      packageScope: 'Balance Mode',
      packageScopeHint: 'Standard balance groups must be assigned to a balance mode. Users can only see and use groups that match the mode they purchased.',
    ...
    providerStatus: {
      ...
      description: 'View provider account availability, errors, and latency from real usage records without proactive upstream probes.',
      refresh: 'Refresh',
      loadError: 'Failed to load provider account status',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: 'Affiliate Rebates',
          description: 'Enable the user-facing affiliate rebate entry and configure the global rate, freeze period, and custom user rules. Disabled by default.',
          enabled: 'Enable Affiliate Rebates',
          enabledHint: 'When off, the user sidebar entry is hidden and affiliate code / rebate views are unavailable.',
          rebateRate: 'Global rebate rate',
          rebateRateHint: 'Default rebate rate for regular affiliate relationships. Custom users can override it.',
          freezeHours: 'Rebate freeze time (hours)',
          freezeHoursDesc: 'New rebates stay pending first and become withdrawable after the freeze period.',
          durationDays: 'Rebate duration window (days)',
          durationDaysDesc: 'Only purchases within this many days after signup generate rebates. Use 0 for no time limit.',
          perInviteeCap: 'Rebate cap per invitee',
          perInviteeCapDesc: 'Maximum cumulative rebate generated by the same invitee. Use 0 for no cap.',
          customUsers: {
            title: 'Custom user settings',
            description: 'Assign custom affiliate codes and custom rebate rates to selected users.',
            addButton: 'Add user',
            searchPlaceholder: 'Search by email or username',
            batchButton: 'Batch set ({count})',
            col: {
              email: 'Email',
              username: 'Username',
              code: 'Affiliate code',
            ...
            empty: 'No custom affiliate users yet',
            customBadge: 'Custom',
            useGlobal: 'Use global rate',
            totalLabel: '{total} users total',
            resetTitle: 'Clear custom settings',
            resetMessage: 'Clear the custom affiliate code and rebate rate for {email}? A regular system code will be regenerated.',
          },
          modal: {
            addTitle: 'Add custom user',
            editTitle: 'Edit custom user',
            userLabel: 'User',
            changeUser: 'Choose another user',
            userPlaceholder: 'Search by email or username',
            codeLabel: 'Custom affiliate code',
            codePlaceholder: 'Leave empty to use the system-generated code',
            codeHint: 'Set a memorable code if needed. Leave empty to keep it unchanged.',
            rateLabel: 'Custom rebate rate',
            ratePlaceholder: 'Leave empty to use global rate',
            rateHint: 'Enter a percentage from 0 to 100. Leave empty to use the global rate.',
            errorEmpty: 'Select a user or enter a valid setting before saving.',
            errorBadRate: 'Rebate rate must be between 0 and 100.',
          },
          batchModal: {
            title: 'Batch set rebate rate ({count} users)',
            hint: 'Apply one rebate rate to the selected custom users.',
            placeholder: 'For example: 10',
            clearHint: 'Submit with an empty value to clear custom rates and use the global rate.',
          },
        },
      },
  ...
  payment: {
    ...
    balancePackages: {
      ...
      codex: 'Codex',
      general: 'General',
      empty: 'No balance packages available',
      buyNow: 'Buy Now',
      payNow: 'Pay ¥{amount}',
      backToList: 'Back to Packages',
      supportRange: 'Support Range',
      supportsCodexOnly: 'Only available for Codex groups',
      supportsGeneralOnly: 'Only available for General groups',
      noMixedScope: 'Cannot be mixed with balance from another balance mode',
      currentScopeCodex: 'Current balance mode: Codex',
      currentScopeGeneral: 'Current balance mode: General',
      currentScopeHint: 'You can only continue buying packages from the same balance mode.',
      unavailable: 'Unavailable',
      unavailableCurrentScope: 'Another balance mode is still active on this account. Spend it first before switching.',
      purchaseNotice: 'Purchased credit is added to your account balance and follows the selected balance mode restrictions.',
      ...
      modeGuideSubtitle: 'Check the scope and switching rules before you purchase.',
      modeGuideCodexTitle: 'For Codex groups only',
      modeGuideCodexDesc: 'Use this mode when the balance should only be spent on Codex groups.',
      modeGuideGeneralTitle: 'For General groups only',
      modeGuideGeneralDesc: 'General balance is suitable for Claude and Codex usage scenarios and follows General group rules after purchase.',
      noticeSingleMode: 'Only one balance mode can be active at a time.',
      noticeSwitch: 'If another balance mode still has remaining balance, spend it first or use force switch mode before purchasing a new package.',
      noticeForceSwitch: 'Force switching clears the old mode balance and cannot be undone.',
    },
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
      PACKAGE_SCOPE_NOT_ALLOWED: 'The current balance mode does not support this group or payment target.',
      PACKAGE_SCOPE_CONFLICT: 'A balance from another mode is still active, so you cannot buy a new package yet.',
      REFUND_UNSUPPORTED: 'Automatic refunds are not supported for balance package orders. Please contact an administrator.',
      BALANCE_PACKAGE_REFERENCED: 'This balance package is referenced by historical orders and cannot be deleted. Please disable it instead.',
    },
    ...
    admin: {
      ...
      planName: 'Plan Name',
      balancePackageName: 'Balance Package Name',
      planDescription: 'Plan Description',
      createPlan: 'Create Plan',
      editPlan: 'Edit Plan',
      deletePlan: 'Delete Plan',
      deletePlanConfirm: 'Are you sure you want to delete this plan?',
      createBalancePackage: 'Create Balance Package',
      editBalancePackage: 'Edit Balance Package',
      deleteBalancePackage: 'Delete Balance Package',
      deleteBalancePackageConfirm: 'Are you sure you want to delete this balance package?',
      originalPrice: 'Original Price',
      price: 'Price',
      balancePackageCreditAmount: 'Credited Balance',
      balancePackageProductName: 'Payment Product Name',
      balancePackageDisplayTags: 'Display Tags',
      balancePackageDisplayTagsPlaceholder: 'Enter a tag and press Enter or click Add',
      balancePackageDisplayTagsHint: 'Add up to 3 display tags. Keep each tag within 10 characters when possible.',
      validityDays: 'Validity (days)',
