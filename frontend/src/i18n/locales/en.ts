export default {
  ...
  keys: {
    ...
    packageScopeHintGeneral: 'Current balance mode: General. You can only bind General groups.',
    statusLabel: 'Status',
  ...
  payment: {
    ...
    balancePackages: {
      ...
      modeGuideGeneralDesc: 'Use this mode when the balance should be spent on General groups.',
