export default {
  ...
  keys: {
    ...
    packageScopeHintCodex: 'Current balance line: Codex. You can only bind Codex groups.',
    packageScopeHintGeneral: 'Current balance line: General. You can only bind General groups.',
    statusLabel: 'Status',
  ...
  admin: {
    ...
    groups: {
      ...
      packageScope: 'Line Type',
      packageScopeHint: 'Standard balance groups must belong to a package line. Users can only see and use groups that match the package line they purchased.',
  ...
  payment: {
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
      PACKAGE_SCOPE_NOT_ALLOWED: 'The current balance line does not support this group or payment target.',
      PACKAGE_SCOPE_CONFLICT: 'A balance from another package line is still active, so you cannot buy a new line yet.',
