...
function onPaymentDone() {
  ...
  const wasBalanceRecharge = paymentState.value.orderType === 'balance'
  resetPayment()
  selectedPlan.value = null
  selectedBalancePackage.value = null
  if (wasBalanceRecharge) {
...
const checkout = ref<CheckoutInfoResponse>({
  ...
  plans: [], balance_packages: [], balance_disabled: false, balance_recharge_multiplier: 1, subscription_usd_to_cny_rate: 0, recharge_fee_rate: 0, help_text: '', help_image_url: '', stripe_publishable_key: '',
})
