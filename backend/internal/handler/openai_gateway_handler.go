...
func (h *OpenAIGatewayHandler) ResponsesWebSocket(c *gin.Context) {
	...
	if err := checkBillingEligibilityWithRetry(ctx, func(checkCtx context.Context) error {
		return h.billingCacheService.CheckBillingEligibility(checkCtx, apiKey.User, apiKey, apiKey.Group, subscription, service.QuotaPlatform(c.Request.Context(), apiKey))
	}, nil); err != nil {
