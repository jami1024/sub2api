...
func (r *oauthEmailAffiliateRepoStub) ListAncestors(context.Context, int64, int) ([]service.AffiliateAncestor, error) {
	panic("unexpected ListAncestors call")
}

func (r *oauthEmailAffiliateRepoStub) CreatePendingRebateRecords(context.Context, []service.AffiliateRebateRecordInput) (int, error) {
	panic("unexpected CreatePendingRebateRecords call")
}

func (r *oauthEmailAffiliateRepoStub) ReleaseDuePendingRebateRecords(context.Context, time.Time) (int, error) {
	panic("unexpected ReleaseDuePendingRebateRecords call")
}

func (r *oauthEmailAffiliateRepoStub) CreateWithdrawalRequest(context.Context, int64, float64, string) (*service.AffiliateWithdrawalRequest, error) {
	panic("unexpected CreateWithdrawalRequest call")
}

func (r *oauthEmailAffiliateRepoStub) ListWithdrawalRequests(context.Context, string, int) ([]service.AffiliateWithdrawalRequest, error) {
	panic("unexpected ListWithdrawalRequests call")
}

func (r *oauthEmailAffiliateRepoStub) ListUserWithdrawalRequests(context.Context, int64, int) ([]service.AffiliateWithdrawalRequest, error) {
	panic("unexpected ListUserWithdrawalRequests call")
}

func (r *oauthEmailAffiliateRepoStub) RejectWithdrawalRequest(context.Context, int64, int64, string) (*service.AffiliateWithdrawalRequest, error) {
	panic("unexpected RejectWithdrawalRequest call")
}

func (r *oauthEmailAffiliateRepoStub) MarkWithdrawalPaid(context.Context, int64, int64, string) (*service.AffiliateWithdrawalRequest, error) {
	panic("unexpected MarkWithdrawalPaid call")
}

func (r *oauthEmailAffiliateRepoStub) ReverseRebatesForOrder(context.Context, int64) error {
	panic("unexpected ReverseRebatesForOrder call")
}

func (r *oauthEmailAffiliateRepoStub) SumPendingRebateByUser(context.Context, int64) (float64, error) {
	panic("unexpected SumPendingRebateByUser call")
}

func (r *oauthEmailAffiliateRepoStub) ListUserRebateRecords(context.Context, int64, int) ([]service.AffiliateRebateRecord, error) {
...
func (r *oauthEmailAffiliateRepoStub) ListAffiliateRebateRecords(context.Context, service.AffiliateRecordFilter) ([]service.AffiliateAdminRebateRecord, int64, error) {
