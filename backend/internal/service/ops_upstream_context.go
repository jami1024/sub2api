...
func newOpsUpstreamErrorEventFromAccountResponse(account *Account, resp *http.Response, base OpsUpstreamErrorEvent) OpsUpstreamErrorEvent {
	base.ProxyID, base.ProxyName = opsUpstreamProxyAttribution(account)
	return newOpsUpstreamErrorEventFromResponse(resp, base)
}
